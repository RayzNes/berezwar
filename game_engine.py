    ...
    def __init__(self):
        ...
        self.provinces = [
            Province(
                1,
                "Центр",
                [(493, 285), (441, 316), (524, 358), (581, 332), (499, 287), (495, 284)]
            ),
            Province(
                2,
                "Младшая школа",
                [(497, 285), (581, 330), (622, 305), (543, 259), (499, 282)]
            ),
            Province(
                3,
            ...
            Province(
                4,
                "Сельская местность",
                [(541, 258), (478, 217), (476, 188), (498, 180), (522, 185), (582, 198), (610, 217), (639, 215),
                 (638, 195), (675, 205), (692, 220), (689, 275), (704, 308), (676, 336), (624, 306), (541, 257)]
            ),
            Province(
                5,
                "ДК",
                [(496, 402), (518, 358), (439, 316), (419, 329), (376, 300), (388, 289), (382, 286), (324, 315),
                 (337, 317), (418, 379), (473, 388), (493, 398)]
            )
        ]
